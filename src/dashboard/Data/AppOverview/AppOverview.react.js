          ...
          <div className={styles.appInfoCard}>
            ...
            <div className={styles.appInformationBox}>
              ...
              <div className="">
                ...
                <div style={{ marginBottom: '8px' }}><span className={styles.greyText}>Hosting Region: </span>{this.context.region} <span><a className={styles.changeRegionLink} href="https://back4app.typeform.com/to/kMjTovFj" target="_blank" rel="noopener noreferrer">Change region</a></span></div>
              </div>
            </div>
          </div>
