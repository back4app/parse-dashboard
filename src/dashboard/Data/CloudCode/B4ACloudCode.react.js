...
class B4ACloudCode extends CloudCode {
  ...
  renderContent() {
    ...
    let alertTipsMessage = <div>
      <p className={styles.paragraph}><b>•</b> To deploy your Cloud Code Functions you can use the Dashboard bellow or the <a href="https://www.back4app.com/docs/platform/parse-cli" target="_blank">Back4App CLI.</a></p>
      <p className={styles.paragraph}><b>•</b> To upload your code you should first click on ADD button and choose what files you want to upload.</p>
      <p className={styles.paragraph}><b>•</b> The first file MUST BE called main.js and any other file or folder MUST BE referenced more in this file.</p>
      <p className={styles.paragraph}><b>•</b> After ADD and REMOVE all files you want, click on the DEPLOY button and commit your operation;</p>
    </div>
